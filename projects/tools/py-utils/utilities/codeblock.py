...
class CodeBlock():
    ...
    def __init__(
        ...
        self.collapse_separation = collapse_separation
    ...
    def __enter__(self):
        if (
            self.add_separation 
            and isinstance(self.top_separation, int) 
            and self.top_separation > 0
        ):
            ...
            if (
                self.collapse_separation 
                and last_codeblock_has_bottom_separation
                and self.top_separation >= last_codeblock_has_bottom_separation
            ):
    ...
    def __exit__(self, exc_type, exc_value, traceback):
        ...
        if (
            self.add_separation 
            and isinstance(self.bottom_separation, int) 
            and self.bottom_separation > 0
        ):
